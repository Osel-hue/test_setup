...
typedef enum {
    ...
    INDEX_OPT_DBUG                      = 36,
    INDEX_OPT_INFILE                    = 37,
    INDEX_OPT_OUTFILE                   = 38,
    INDEX_OPT_CACHEFILE                 = 39,
    INDEX_OPT_VERBOSE                   = 40,
    INDEX_OPT_DECODE                    = 41,
    INDEX_OPT_FRAGROUTE                 = 42,
    INDEX_OPT_FRAGDIR                   = 43,
    INDEX_OPT_SKIP_SOFT_ERRORS          = 44,
...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 *  Enumeration of tcprewrite exit codes
 */
typedef enum {
    TCPREWRITE_EXIT_SUCCESS         = 0,
    TCPREWRITE_EXIT_FAILURE         = 1,
    TCPREWRITE_EXIT_USAGE_ERROR     = 64,
    TCPREWRITE_EXIT_NO_CONFIG_INPUT = 66,
    TCPREWRITE_EXIT_LIBOPTS_FAILURE = 70
}   tcprewrite_exit_code_t;
/**
...
#define SET_OPT_CACHEFILE(a)   STMTS( \
        DESC(CACHEFILE).optActualIndex = 39; \
...
#define VALUE_OPT_FRAGROUTE      0x1019
#define VALUE_OPT_FRAGDIR        0x101A
#define VALUE_OPT_SKIP_SOFT_ERRORS 0x101B
...
#define VALUE_OPT_SAVE_OPTS     0x101C
/** option flag (value) for load-opts-value option */
#define VALUE_OPT_LOAD_OPTS     0x101D
